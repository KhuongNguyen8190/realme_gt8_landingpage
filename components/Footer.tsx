    ...
    <footer className="bg-blue-950 text-blue-100 dark:bg-gray-950 dark:text-gray-400 border-t border-blue-900/40 dark:border-gray-900 py-12 lg:py-16 transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start mb-10 text-center md:text-left">
          ...
          {/* Social Media Links (Dùng SVG nguyên bản để chống lỗi Build Turbopack) */}
          <div className="flex flex-col items-center md:items-end space-y-4">
            <h3 className="text-white font-semibold mb-2">Kết nối với chúng tôi</h3>
            <div className="flex gap-4">
              <a href="#" className="p-2.5 bg-blue-900/50 hover:bg-blue-600 rounded-full text-blue-200 hover:text-white transition-all hover:scale-110">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
              <a href="#" className="p-2.5 bg-blue-900/50 hover:bg-pink-600 rounded-full text-blue-200 hover:text-white transition-all hover:scale-110">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="#" className="p-2.5 bg-blue-900/50 hover:bg-red-600 rounded-full text-blue-200 hover:text-white transition-all hover:scale-110">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33 2.78 2.78 0 0 0 1.94 2c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.33 29 29 0 0 0-.46-5.33z"></path><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"></polygon></svg>
              </a>
              <a href="https://github.com/KhuongNguyen8190" target="_blank" rel="noreferrer" className="p-2.5 bg-blue-900/50 hover:bg-gray-800 rounded-full text-blue-200 hover:text-white transition-all hover:scale-110">
