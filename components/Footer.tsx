        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start mb-10 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-end space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/realmeVietnam" aria-label="Facebook" className="p-2.5 bg-blue-900/50 hover:bg-blue-600 rounded-full text-blue-200 hover:text-white transition-all hover:scale-110">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
              <a href="https://www.instagram.com/realme_vietnam/" aria-label="Instagram" className="p-2.5 bg-blue-900/50 hover:bg-pink-600 rounded-full text-blue-200 hover:text-white transition-all hover:scale-110">
